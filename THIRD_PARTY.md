...
| [MagicalGlassRedux](https://github.com/Bli-AIk/MagicalGlassRedux)                       | Upstream: all rights reserved © original authors; fork additions MIT or Apache-2.0 | Optional UT content library; clone submodule only, excluded from production packages. See `libraries/MagicalGlassRedux/LICENSE-UPSTREAM.md`. |
| [UndertaleMonstersRecreation](https://github.com/Bli-AIk/UndertaleMonstersRecreation)   | Upstream: all rights reserved © original authors; fork additions MIT or Apache-2.0 | Optional UT content library; clone submodule only, excluded from production packages. See `libraries/UndertaleMonstersRecreation/LICENSE-UPSTREAM.md`. |
