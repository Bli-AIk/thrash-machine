...
| [MagicalGlassRedux](https://github.com/Bli-AIk/MagicalGlassRedux)                       | Upstream: all rights reserved © original authors; fork additions MIT or Apache-2.0 | Optional UT content library; ships in release packages when the submodule is present and enabled (stripped when disabled in mod.json). See `libraries/MagicalGlassRedux/LICENSE-UPSTREAM.md`. |
| [UndertaleMonstersRecreation](https://github.com/Bli-AIk/UndertaleMonstersRecreation)   | Upstream: all rights reserved © original authors; fork additions MIT or Apache-2.0 | Optional UT content library; ships in release packages when the submodule is present and enabled (stripped when disabled in mod.json). See `libraries/UndertaleMonstersRecreation/LICENSE-UPSTREAM.md`. |
