...
THRASH_MACHINE_KRISTAL_REF="${THRASH_MACHINE_KRISTAL_REF:-8e592d84065263138d4e92593f0a4ab780d93822}"
...
choose_kristal_source() {
    ...
    if [ -z "$THRASH_MACHINE_KRISTAL_EXPECTED_VERSION_ENV" ] \
        ...
        case "$THRASH_MACHINE_KRISTAL_SOURCE:$THRASH_MACHINE_KRISTAL_REF" in
            commit:8e592d84065263138d4e92593f0a4ab780d93822) THRASH_MACHINE_KRISTAL_VERIFY_VERSION=1 ;;
...
resolve_kristal_source() {
    ...
    if [ -n "$THRASH_MACHINE_KRISTAL_REF_ENV" ] \
        && [ "$THRASH_MACHINE_KRISTAL_REF_ENV" != "8e592d84065263138d4e92593f0a4ab780d93822" ]; then
