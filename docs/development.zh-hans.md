...
| libraries/kristal-i18n | 语言资源与本地化 hooks。 |
...
先在依赖仓库完成测试和发布，再更新本仓库的 gitlink：
    ...
    git -C libraries/kristal-i18n fetch origin
    git -C libraries/kristal-i18n checkout --detach origin/main
    git add libraries/kristal-i18n
